    ...
    try {
      ...
      if (
        ...
        const successMessage =
          response?.message || "Withdraw request created successfully.";
    ...
    <div className="min-h-screen bg-artisan-brown-950">
      ...
      <div className="flex">
        ...
        <div className="flex-1 p-8">
          ...
          {/* Wallet Balance Card */}
          <Card className="bg-gradient-to-r from-artisan-gold-600/20 to-artisan-gold-500/10 border-artisan-gold-500/30 mb-8">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-artisan-brown-300 text-sm mb-1">
                      Số dư ví
                    </p>
                    {loadingBalance ? (
