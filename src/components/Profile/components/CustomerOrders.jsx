...
const CustomerOrders = () => {
  ...
  // Fetch user profile and check if artist
  useEffect(() => {
      ...
      try {
        ...
        if (response?.isSuccess && response?.data) {
          ...
          if (response.data.role === "Artist") {
            ...
            // Also check if has artist profile
            try {
              const artistResponse = await getArtistProfile();
              if (artistResponse?.isSuccess && artistResponse?.data) {
                setIsArtist(true);
              }
            } catch {
              setIsArtist(false);
          ...
          <div className="p-6">
            ...
            <nav className="space-y-2">
              ...
              <button
                ...
                className="w-full flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors bg-artisan-gold-500 text-white"
              >
                  ...
                  <p className="text-2xl font-bold text-white">
                    {
                      orders.filter(
                        (o) =>
                          o.status === "Shipping" || o.status === "SHIPPING"
                      ).length
                    }
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-artisan-brown-800/50 rounded-lg p-4">
                    ...
                    <div className="space-y-3">
                      {(orderDetail.orderItems || orderDetail.items || []).map(
                        (item, index) => (
                          <div
                            key={index}
                    ...
                    <div className="mt-4 pt-4 border-t border-artisan-brown-700 space-y-2">
                      ...
                      <div className="flex justify-between items-center pt-2 border-t border-artisan-brown-600">
                        <span className="text-artisan-brown-300 font-medium">
                          Tổng cộng:
                        </span>
