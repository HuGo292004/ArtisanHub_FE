...
const PaymentSuccess = () => {
  ...
  const { clearCart, loadCartItems, cartItems, removeFromCart } = useCart();
        ...
        try {
          ...
          try {
            ...
            if (clearResult && clearResult.isSuccess) {
              ...
              throw new Error("API clear không thành công, dùng phương pháp backup");
            }
          } catch (clearError) {
    ...
    return (
      <div className="min-h-screen bg-artisan-brown-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-artisan-brown-300 text-lg">Đang xử lý thanh toán...</p>
        </div>
      </div>
    );
  }
