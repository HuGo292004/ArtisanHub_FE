    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden hero-pattern">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg lg:text-xl text-artisan-brown-600 max-w-2xl mx-auto leading-relaxed mb-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            <div className="text-center">
              <div className="w-16 h-16 mx-auto rounded-full bg-gradient-to-br from-artisan-gold-100 to-artisan-brown-100 flex items-center justify-center mb-4">
                <Heart className="w-8 h-8 text-artisan-gold-600" />
              </div>
              <h3 className="font-semibold text-white mb-2">Tâm huyết</h3>
              <p className="text-sm text-artisan-brown-600">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-white mb-2">Chất lượng</h3>
              <p className="text-sm text-artisan-brown-600">
                Sản phẩm tinh xảo
              </p>
            </div>
            <div className="text-center">
              ...
              <h3 className="font-semibold text-white mb-2">Uy tín</h3>
              <p className="text-sm text-artisan-brown-600">Được tin tưởng</p>
            </div>
          </div>
        </div>
      </div>
